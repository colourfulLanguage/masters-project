...
def run():
    ...
    # seperation_hists_1 = np.load(f"{WORK_DIR}/methyl_electric_inference_12438954_12744115_120_000/any_muon_spin_correlation.npy")
    # seperation_hists_2 = np.load(f"{WORK_DIR}/methyl_electric_inference_12438954_12823464_120_000/any_muon_spin_correlation.npy")
    # seperation_hists_3 = np.load(f"{WORK_DIR}/methyl_electric_inference_12438954_12823615_120_000/any_muon_spin_correlation.npy")

    # seperation_hists = seperation_hists_1 + seperation_hists_2 + seperation_hists_3

    seperation_hists = np.load(
        f"{WORK_DIR}/methyl_electric_inference_12438954_12927563_120_000/any_muon_spin_correlation.npy"
    )
    ...
    plt.ylim(-0.03, 0.03)
    # plt.legend()
    plt.savefig(f"plots/methyl_electric_separation_fit_observable.png")
